...
/**
 * @author Eldon Clase encargada de representar los datos de un individuo de una
 *         partida. Se define el individuo como el conjunto formado por parte de
 *         cada jugador y las respectivas opciones seleccionadas a lo largo de
 *         la partida.
 *
 */
public class PlayerEntity {
	...
	public static final String[] ROLE_NAME = { "NONE", "TOP", "MID", "CARRY",
			"SUPPORT", "JUNGLER" };
	private int champID;
	...
	public String toString() {
		String name = GetChampNameBy.id(getChampID());
		if(name == null)
			name = Integer.toString(getChampID());
		return "" + name;
